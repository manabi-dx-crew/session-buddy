"""
設定管理モジュール - 環境変数から全設定を読み込み
"""
import os

# ローカル開発時のみ.envファイルを読み込み
try:
...
MODEL_NAME = os.environ.get('MODEL_NAME')  # 使用するGeminiモデル

# Dify連携設定
DIFY_BASE_URL = os.environ.get('DIFY_BASE_URL')  # DifyのベースURL
DIFY_API_KEY = os.environ.get('DIFY_API_KEY')  # DifyのAPIキー
AI_PROVIDER = os.environ.get('AI_PROVIDER', 'gemini')  # 使用するAIプロバイダー
